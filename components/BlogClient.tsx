      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-4">
            Latest <span className="text-yellow-500 dark:text-yellow-400">Articles</span>
          </h2>
  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div>
            <span className="text-yellow-500 dark:text-yellow-400 text-sm font-bold tracking-widest uppercase">
              My Thoughts
            </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          <article
            className={`lg:col-span-2 relative flex flex-col justify-end rounded-2xl overflow-hidden border border-purple-300/40 dark:border-purple-800/30 hover:border-yellow-500/50 dark:hover:border-yellow-400/40 transition-all duration-500 group cursor-pointer min-h-105 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
            style={{
          ...
          >
            ...
            <div className="relative z-10 p-8">
              ...
              <h3 className="text-gray-900 dark:text-white text-xl font-extrabold leading-snug mb-4 group-hover:text-yellow-500 dark:group-hover:text-yellow-400 transition-colors duration-200">
                {featured.title}
              </h3>
          ...
          <div className="lg:col-span-3 flex flex-col gap-6">
            {rest.map((post, i: number) => (
              <article
                key={post.slug}
                className={`relative flex flex-col sm:flex-row gap-5 rounded-2xl p-6 border border-purple-300/40 dark:border-purple-800/30 hover:border-yellow-500/40 dark:hover:border-yellow-400/30 transition-all duration-500 group cursor-pointer overflow-hidden ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
                style={{
                  background: restCardBg,
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <h3 className="text-gray-900 dark:text-white text-base font-extrabold leading-snug mb-2 group-hover:text-yellow-500 dark:group-hover:text-yellow-400 transition-colors duration-200 pr-8">
                    {post.title}
                  </h3>
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-sm font-bold text-yellow-500 dark:text-yellow-400 hover:text-yellow-600 dark:hover:text-yellow-300 transition-colors duration-200"
          >
