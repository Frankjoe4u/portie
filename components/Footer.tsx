...
export default function Footer() {
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="text-center md:text-left">
          <h3 className="text-white text-xl font-extrabold">
            Frank <span className="text-yellow-400">Joe</span>
          </h3>
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="text-gray-400 hover:text-yellow-400 transition-colors cursor-pointer bg-transparent border-none p-0"
          >
          ...
          <button
            ...
            className="text-gray-500 hover:text-yellow-400 transition-colors cursor-pointer bg-transparent border-none p-0"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      >
        <h4 className="text-gray-400 text-xs font-semibold uppercase tracking-widest mb-4 text-center md:text-left"></h4>
