...
export default function About() {
  ...
  return (
    <section
      id="about"
      ref={sectionRef}
      className="relative py-24 px-6 overflow-hidden bg-[linear-gradient(180deg,#1a003e_0%,#0d0020_100%)]"
    >
      {/* Background glows */}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-yellow-400 text-5xl font-semibold tracking-wider mb-2">
            ABOUT ME
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-9 items-center">
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 w-full h-full rounded-tl-3xl rounded-br-3xl bg-purple-700/30 blur-sm skew-y-2" />

            {/* Photo — wider on desktop */}
            <div className="relative z-10 w-full max-w-none rounded-2xl overflow-hidden border-2 border-yellow-400/20 shadow-2xl shadow-purple-900/60">
              <img
                src="/pix1.jpg"
                alt="Frank Joe"
          ...
          >
            ...
            >
              ...
              <div className="relative z-10 w-full max-w-xs rounded-2xl overflow-hidden border-2 border-yellow-400/20 shadow-2xl shadow-purple-900/60">
                <img
                  src="/pix1.jpg"
                  alt="Frank Joe"
                  className="w-full h-auto object-cover"
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                ...
                className="px-6 py-3 rounded-full border border-yellow-400/50 hover:border-yellow-400 text-yellow-400 hover:bg-yellow-400/10 text-sm font-bold transition-all duration-200 tracking-widest"
              >
                LEARN MORE
              </a>
            </div>
        ...
        >
          {stats.map((s, i) => (
            <div
              key={i}
              className="relative text-center p-5 rounded-2xl border border-purple-800/30 hover:border-yellow-400/40 transition-all duration-300 group overflow-hidden bg-[rgba(124,58,237,0.05)]"
            >
              ...
              <p className="text-3xl md:text-4xl font-black text-yellow-400 mb-1">
                {s.value}
              </p>
